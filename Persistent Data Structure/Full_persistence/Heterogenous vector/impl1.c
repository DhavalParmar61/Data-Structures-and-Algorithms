...
node* int_addNode(int data, int version)
{
  ...
  if(list_ptr->mod->version == unused)
      ...
      if(list_ptr->mod->version <= version)
	{
	  switch(list_ptr->mod->identifier[0])
	    {
	    case 'i': {
	      newnode_parent = int_addNode(list_ptr->mod->int_data, current_version);
	      break;
	    }
	    case 'f': {
      ...
      else
	{
	  switch(list_ptr->identifier[0])
	    {
	    case 'i': {
	      newnode_parent = int_addNode(list_ptr->int_data, current_version);
	      break;
	    }
	    case 'f': {
  ...
  if(list_ptr->mod->version == unused)
      ...
      else
	{
	  ...
	  switch(list_ptr->mod->identifier[0])
	    {
	    case 'i': {
	      trailNode = int_addNode(list_ptr->mod->int_data, current_version);
	      break;
	    }
	    case 'f': {
	    ...
	    {
	    case 'i': {
	      trailNode = int_addNode(list_ptr->int_data, current_version);
	      break;
	    }
	    case 'f': {
      ...
      else
	{
	  ...
	  switch(str[0])
	    ...
	    case 'i': {
	      int int_data;
	      sscanf(str, "%*[^','],%d", &int_data);
	      newnode = int_addNode(int_data, current_version);
	      break;
	    }
	    case 'f': {
	      float float_data;
	  ...
	  if((list_ptr->mod->version == unused) || (list_ptr->mod->version > version))
	      ...
	      else
		{
		  ...
		  if(list_ptr->next->mod->version <= version)
			...
			{
			case 'i': {
			  newnode = int_addNode(list_ptr->next->mod->int_data, current_version);
			  break;
			}
			case 'f': {
			...
			{
			case 'i': {
			  newnode = int_addNode(list_ptr->next->int_data, current_version);
			  break;
			}
			case 'f': {
	      ...
	      else
		{
		  ...
		  if(list_ptr->mod->next->mod->version <= version)
			...
			{
			case 'i': {
			  newnode = int_addNode(list_ptr->mod->next->mod->int_data, current_version);
			  break;
			}
			case 'f': {
			...
			{
			case 'i': {
			  newnode = int_addNode(list_ptr->mod->next->int_data, current_version);
			  break;
			}
			case 'f': {
	  ...
	  if(list_ptr->prev->mod->version == unused)
	      ...
	      if(list_ptr->prev->mod->version <= version)
		{
		  switch(list_ptr->prev->mod->identifier[0])
		    {
		    case 'i': {
		      newnode = int_addNode(list_ptr->prev->mod->int_data, current_version);
		      break;
		    }
		    case 'f': {
	      ...
	      else
		{
		  switch(list_ptr->prev->identifier[0])
		    {
		    case 'i': {
		      newnode = int_addNode(list_ptr->prev->int_data, current_version);
		      break;
		    }
		    case 'f': {
	  ...
	  if(list_ptr->mod->prev->mod->version == unused)
	      ...
	      if(list_ptr->mod->prev->mod->version <= version)
		{
		  switch(list_ptr->mod->prev->mod->identifier[0])
		    {
		    case 'i': {
		      newnode = int_addNode(list_ptr->mod->prev->mod->int_data, current_version);
		      break;
		    }
		    case 'f': {
	      ...
	      else
		{
		  switch(list_ptr->mod->prev->identifier[0])
		    {
		    case 'i': {
		      newnode = int_addNode(list_ptr->mod->prev->int_data, current_version);
		      break;
		    }
		    case 'f': {
	  ...
	  if((list_ptr->prev->mod->version == unused) && (list_ptr->next->mod->version == unused))
	      ...
	      if(list_ptr->prev->mod->version <= version)
		{
		  switch(list_ptr->prev->mod->identifier[0])
		    {
		    case 'i': {
		      newnode_prev = int_addNode(list_ptr->prev->mod->int_data, current_version);
		      break;
		    }
		    case 'f': {
	      ...
	      else
		{
		  switch(list_ptr->prev->identifier[0])
		    {
		    case 'i': {
		      newnode_prev = int_addNode(list_ptr->prev->int_data, current_version);
		      break;
		    }
		    case 'f': {
	      ...
	      if(list_ptr->next->mod->version <= version)
		{
		  switch(list_ptr->next->mod->identifier[0])
		    {
		    case 'i': {
		      newnode_next = int_addNode(list_ptr->next->mod->int_data, current_version);
		      break;
		    }
		    case 'f': {
	      ...
	      else
		{
		  switch(list_ptr->next->identifier[0])
		    {
		    case 'i': {
		      newnode_next = int_addNode(list_ptr->next->int_data, current_version);
		      break;
		    }
		    case 'f': {
	  ...
	  if((list_ptr->mod->prev->mod->version == unused) && (list_ptr->mod->next->mod->version == unused))
	      ...
	      if(list_ptr->mod->prev->mod->version <= version)
		{
		  switch(list_ptr->mod->prev->mod->identifier[0])
		    {
		    case 'i': {
		      newnode_prev = int_addNode(list_ptr->mod->prev->mod->int_data, current_version);
		      break;
		    }
		    case 'f': {
	      ...
	      else
		{
		  switch(list_ptr->mod->prev->identifier[0])
		    {
		    case 'i': {
		      newnode_prev = int_addNode(list_ptr->mod->prev->int_data, current_version);
		      break;
		    }
		    case 'f': {
	      ...
	      if(list_ptr->mod->next->mod->version <= version)
		{
		  switch(list_ptr->mod->next->mod->identifier[0])
		    {
		    case 'i': {
		      newnode_next = int_addNode(list_ptr->mod->next->mod->int_data, current_version);
		      break;
		    }
		    case 'f': {
	      ...
	      else
		{
		  switch(list_ptr->mod->next->identifier[0])
		    {
		    case 'i': {
		      newnode_next = int_addNode(list_ptr->mod->next->int_data, current_version);
		      break;
		    }
		    case 'f': {
