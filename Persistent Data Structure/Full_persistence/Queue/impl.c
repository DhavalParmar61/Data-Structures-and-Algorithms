...
queue* initialize()
{
  queue* newlist = (queue*) malloc(sizeof(queue));
  ...
  if(list_ptr->mod->version == unused)
    {
      ...
      list_ptr->mod->next =  update_parentright(list, list_ptr->next, list_ptr, current_version, version);
	...
	{	  
	  ...
	  newnode_parent->next = update_parentright(list, list_ptr->mod->next, newnode_parent, current_version, version);
	}
      else
	{
	  newnode_parent = addNode(list_ptr->data, current_version);
	  ...
	  newnode_parent->prev = newnode;
	  newnode_parent->next = update_parentright(list, list_ptr->next, newnode_parent, current_version, version);
	}
      return newnode_parent;
    }
...
bool insert_list(queue* list, int data, int index, int version)
{
  ...
  if(list_ptr->mod->version == unused)
      ...
      if(index != 0)
	{
	  ...
	  newnode->next = update_parentright(list, list_ptr->next, newnode, current_version, version);
      ...
      if(index !=0)
	{
	  if(list_ptr->mod->version <= version)
	    {
	      newnode->next = update_parentright(list, list_ptr->mod->next, newnode, current_version, version);
	      newnode->prev = update_parentleft(list, list_ptr, newnode, current_version, version);
	    }
	  else
	    {
	  ...
	  if(list_ptr->mod->version <= version)
	    {
	      ...
	      trailNode->next = update_parentright(list, list_ptr->mod->next, trailNode, current_version, version);	
	    }
	  else
	    {
	      trailNode = addNode(list_ptr->data, current_version);
	      trailNode->next = update_parentright(list, list_ptr->next, trailNode, current_version, version);	
	    }
...
bool delete_list(queue* list, int index, int version)
{
  if(index<0)
    {
      printf("Index cannot be negative");
		  ...
		  if(list_ptr->next->mod->version <= version)
		    {
		      ...
		      newnode->next = update_parentright(list, list_ptr->next->mod->next, newnode, current_version, version);
		    }
		  else
		    {
		      newnode = addNode(list_ptr->next->data, current_version);
		      newnode->next = update_parentright(list, list_ptr->next->next, newnode, current_version, version);
		    }
		  ...
		  if(list_ptr->mod->next->mod->version <= version)
		    {
		      ...
		      newnode->next = update_parentright(list, list_ptr->mod->next->mod->next, newnode, current_version, version);
		    }
		  else
		    {
		      newnode = addNode(list_ptr->mod->next->data, current_version);
		      newnode->next = update_parentright(list, list_ptr->mod->next->next, newnode, current_version, version);
		    }
      ...
      if((list_ptr->mod->version == unused) || (list_ptr->mod->version > version))
	{
	  if((list_ptr->prev->mod->version == unused) && (list_ptr->next->mod->version == unused))
	      ...
	      if(list_ptr->next->mod->version <= version)
		{
		  ...
		  newnode_next->next = update_parentright(list, list_ptr->next->mod->next, newnode_next, current_version, version);
		}
	      else
		{
		  newnode_next = addNode(list_ptr->next->data, current_version);
		  newnode_next->next = update_parentright(list, list_ptr->next->next, newnode_next, current_version, version);
		}
      ...
      else
	{
	  if((list_ptr->mod->prev->mod->version == unused) && (list_ptr->mod->next->mod->version == unused))
	      ...
	      if(list_ptr->mod->next->mod->version <= version)
		{
		  ...
		  newnode_next->next = update_parentright(list, list_ptr->mod->next->mod->next, newnode_next, current_version, version);
		}
	      else
		{
		  newnode_next = addNode(list_ptr->mod->next->data, current_version);
		  newnode_next->next = update_parentright(list, list_ptr->mod->next->next, newnode_next, current_version, version);
		}
...
{
  if(queue->head[version] == NULL) return true;
  else false;
}
...
bool insert(queue* queue, int data, int version)
{
  ...
  for(list_ptr = queue->head[version]; list_ptr != NULL; last_index++)
    {
  ...
  return (insert_list(queue, data, last_index, version));
}


int delete_queue(queue* queue, int version)
{
  return delete_list(queue, 0, version);
}
